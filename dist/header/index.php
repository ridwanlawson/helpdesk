...
<head>
  ...
  <link rel="icon" href="assets/img/bni/bni.jpg">
  <!-- General CSS Files -->
        ...
        <aside id="sidebar-wrapper">
          <div class="sidebar-brand">
            <a href="index.php">
              ...
              <span style="display: block; margin-top: 5px; margin-bottom: 100px; line-height: 1.2; max-width: 100%; word-wrap: break-word;">
                <?php echo $judul->nm_perusahaan; ?>
              </span>
            </a>
          </div>
          <div class="sidebar-brand sidebar-brand-sm">
            <a href="index.php"><?php echo $judul->init_perusahaan ?></a>
          </div>
          <?php
