                    ...
                    <div class="table-responsive">
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            <td><?php echo $no++ ?></td>
                            <td><?php echo ucwords($data->nm_pekerjaan); ?></td>
                            <td><button class="btn btn-primary"  data-toggle="modal" data-target="#show" data-id="<?php echo $data->id_pekerjaan ?>">Ubah</button> | <a href="<?php echo $_SESSION['direct'] ?>delete.php?hd=master&fd=pekerjaan&id=<?php echo $data->id_pekerjaan; ?>" class="btn btn-danger">Hapus</a></td>
                          </tr>
                          <?php } ?>
                        </tbody>
                      </table>
      ...
      <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <form action="<?php echo $_SESSION['direct'] ?>create.php?hd=master&fd=pekerjaan" method="post">
