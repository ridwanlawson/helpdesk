                        ...
                        <tbody>
                              ...
                              if (!empty($tahuns) && !empty($bulans)){
                                $query = "SELECT pesan.*, user.*
                                                 FROM pesan, user
                                                  ...
                                                  AND pesan.status_pesan = 'proses'
                                                  AND pesan.id_pengirim = user.id_user
                                                  OR pesan.status_pesan = 'proses teknisi'
                                                  AND  MONTH(tanggal_pesan) = '$bulans'
                                                  AND YEAR(tanggal_pesan) = '$tahuns'
                                                  AND pesan.status_pesan = 'proses'
                                                  AND pesan.id_pengirim = user.id_user
                          ...
                          <tr>
                            ...
                            <td>
                                ...
                                <a class="btn text-light btn-primary" href="<?php echo $_SESSION['direct'].'selesai.php?id='.$data->id_pesan.'&hd=transaksi&fd=processing'?>">Selesai</a>
                            </td>
                          </tr>
                          <?php } ?>
                        </tbody>
