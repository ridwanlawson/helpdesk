...
<head>
  ...
  <title>Login &mdash; <?php echo $judul->nm_perusahaan; ?></title>
...
<style>
  body {
    background-image: url('dist/assets/sawahlunto/3.jpg');
    background-repeat: no-repeat;
    background-size: cover; /* Menyesuaikan ukuran layar */
    background-position: center; /* Memposisikan di tengah */
        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            <div class="login-brand">
              <img src="dist/assets/img/logo.png" alt="logo" width="100" class="">
            </div>
            ...
            <div class="simple-footer text-white">
              Copyright &copy; <?php echo $judul->nm_perusahaan; ?> <?php echo date("Y") ?>
            </div>
          </div>
        </div>
      </div>
